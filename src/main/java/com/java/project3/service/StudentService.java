...
//        ResponseDto responseDto = new ResponseDto();
//        Optional<CourseClass> grade = gradeRepository.findById(studentDTO.getGradeId());
...
//        if (student.isPresent()) {
//            CourseClass courseClass = gradeRepository.findById(studentDTO.getGradeId()).get();
//
//            Student student1 = toStudent.getDestination(student.get(), studentDTO);
//            student1.setGradeName(courseClass.getName());
