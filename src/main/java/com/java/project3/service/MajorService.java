...
////        List<CourseClass> grades = gradeRepository.search(subject.get().getMajorId());
...
//            List<CourseClass> courseClasses = gradeRepository.search(majorDTO.getId());
...
//        Optional<Major> major = majorRepository.findById(id);
//        if (major.isPresent()) {
//            CourseClass courseClass = gradeRepository.findByMajorId(id);
//            if (courseClass == null) {
