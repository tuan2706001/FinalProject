...
//
//        List<MajorDTO> majorDTOS = null;
//        if (courseClassDTO.getMajorId() != null) {
//            ResponseDto responseDto1 = majorService.findById(courseClassDTO.getMajorId());
//            MajorDTO majorDTO = (MajorDTO) responseDto1.getObject();
//            model.addAttribute("courseId", majorDTO.getCourseId());
//
//            //get khóa
...
//
//        ResponseDto responseDto = gradeServcie.create(courseClassDTO);
...
//            @ModelAttribute CourseClassDTO courseClassDTO
//    ) {
//        ResponseDto responseDto = gradeServcie.update(courseClassDTO);
//        return "redirect:/quan-ly-lop";
//    }
//
