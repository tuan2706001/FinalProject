...
if (window.location.pathname.indexOf('/quan-tri-nha-truong/tien-ich/danh-muc/') === -1){
    setCookie('flag',false,1)
}
if (window.location.pathname.indexOf('/quan-tri-nha-truong/tien-ich/danh-muc/') === 0){
    setCookie('flag',true,1)
}
if (window.location.pathname.indexOf('/quan-tri-nha-truong/tien-ich/do-an/') === -1){
    setCookie('flag1',false,1)
}
if (window.location.pathname.indexOf('/quan-tri-nha-truong/tien-ich/do-an/') === 0){
